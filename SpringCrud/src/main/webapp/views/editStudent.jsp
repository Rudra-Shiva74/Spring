		...
		<form class="row g-3 needs-validation" novalidate action="update"
			...
			<div class="col-md-4">
				<label for="validationCustom01" class="form-label">Name</label> <input
					name="name" type="text" value="${student.name }"
			...
			<div class="col-md-4">
				<label for="validationCustom02" class="form-label">Registration
					Number</label> <input type="text" name="regno" value="${student.regno }"
					readonly class="form-control border border-1 border-dark"
					id="validationCustom02" required>
				<div class="valid-feedback">Looks good!</div>
				<input type="hidden" name="id" value="${student.id }" />
			</div>
			<div class="col-md-4">
				<c:if test="${fn:contains(student.gender	,'Female')}">true</c:if>
				<label for="validationCustomUsername" class="form-label">Gender</label>
				<div class="input-group has-validation">
					<input name="gender" type="radio"
						<c:if test="${fn:contains(student.gender	,'Male')}">checked</c:if>
						...
						<c:if test="${fn:contains(student.gender	,'Female')}">checked</c:if>
			...
			<div class="col-md-6">
				<label for="validationCustom03" class="form-label">email</label> <input
					...
					value="${student.email }" name="email" id="validationCustom03"
					required>
			...
			<div class="col-md-3">
				<label for="validationCustom04" class="form-label">State</label> <select
					...
					<option selected value="${student.state }">${student.state }</option>
			...
			<div class="col-md-3">
				...
				<input type="date" class="form-control  border border-1 border-dark"
					value="${student.birthdate }" name="birthdate"
